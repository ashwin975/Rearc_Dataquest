...
BLS_PREFIX = os.environ.get("BLS_PREFIX", "bls_data/")

API_URL = os.environ.get("API_URL", "")
API_PREFIX = os.environ.get("API_PREFIX", "api_data/")
JSON_FILE_NAME = os.environ.get("JSON_FILE_NAME", "population.json")

USER_AGENT = os.environ.get(
    "USER_AGENT",
    "Mozilla/5.0 (compatible; DataSyncBot/1.0; +https://ashwinsingaram.us)"
)
